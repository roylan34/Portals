...
* 10/08/2019
*
* This file is contains reports table of Machine Receipts.
*
*/ 
...
$db = Database::getInstance();
	...
	$db->selectQuery("firm_name, model, COUNT(*) total_model ","sap_db.tbl_receipts_auto_import WHERE trans_type='MACHINE RECEIPTS' $search
