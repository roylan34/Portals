...
var autoDrpDownMrf = {
    ...
    bnrf: function (selectedId) {
        return '<select class="mrf-material s1_bn_rf" name="s1_bn_rf">'
            + '<option value="">---</option>'
            + '<option value="1" ' + (selectedId == 1 ? "selected" : "") + '>Brand New (BN)</option>'
            + '<option value="2" ' + (selectedId == 2 ? "selected" : "") + '>Refurbished (RF)</option></select>';
    }
};
