var dtAccounts = {
    ...
    update: function () {
        ...
        var data = {
            ...
            action_mif: action_mif, action_invnt: action_invnt, action_mrf: action_mrf, pm_type: pm_type, mrf_type: mrf_type, app_report: app_report, action_report: JSON.stringify(action_report)
        };
    ...
    add: function () {
        ...
        var data = {
            action: 'add', username: username, pass: pass, fname: fname, mname: mname, lname: lname, email: email,
            ...
            app_report: app_report, action_report: JSON.stringify(action_report)
        };
