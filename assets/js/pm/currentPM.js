var dtCurrentPM = { //For development
        ...
        this.dtInstance = $("#dtCurrentPM").DataTable({
            ...
            "ajax": {
                ...
                complete: function (data) {
                    $(".dt-buttons a").removeClass('disabled');
                    $("#hdnPmSchedDate").val(data.responseJSON.sched_date);
                }
            },
            "buttons": [
                {
    ...
    update: function (pm_id) { //Edit record by company id.
        if (pm_id != null) {
            ...
            var data = {
                action: 'update', brand: brand, model: model, category: category, type: type, location: loc, department: depart, no_of_user: no_of_user, mif_id: mif_id, pm_id: pm_id, manufacture: manufacture,
