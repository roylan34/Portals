                ...
                },
                {
                    data: null, render: function (data, type, full, meta) {
                        if (data.status.toUpperCase() == 'CANCEL') {
                            return '<a href="#" style="color: #c34838" data-toggle="popover" title="" data-placement="left" data-content="' + data.reason_cancel + '" data-trigger="focus" data-original-title="Reason"><i class="fa fa-comment"></i></a>';
                        }
                        else {
                            return '';
                        }
